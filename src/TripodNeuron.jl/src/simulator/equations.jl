...
function ΔvDend2(v::Float32,axial::Float32, g::AbstractVector{Float32},  pm::PassiveMembraneParameters, syn::Synapse)::Float32
...
# Euler Integration
@inline function _Δv_dend(v::Float32, axial::Float32,g::AbstractVector{Float32}, pm::PassiveMembraneParameters, syn::Synapse)::Float32
	 i = syn_current(v, g,syn)
	 return  pm.C⁻ *(-(v - pm.Er)/pm.Rm - min(abs(i), 1500)*sign(i)  -axial)
end

@inline function _Δv_soma(v::Float32, w::Float32,axial::Float32, θ::Float32, g::AbstractVector{Float32}, Neuron::NeuronParams, syn::Synapse)::Float32
...
@inline function Δv_soma_nospike(v::Float32, w::Float32,axial::Float32, g::AbstractVector{Float32}, Neuron::NeuronParams, syn::Synapse)::Float32
	@unpack gl, C⁻, Er, ΔT, ΔT⁻ = Neuron
...
function update_synapse_soma!(syn_arr::AbstractMatrix{Float32}, inh_::Float32, exc_::Float32, syn::Synapse)
