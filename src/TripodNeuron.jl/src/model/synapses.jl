...
@with_kw struct Receptor <:AbstractReceptor
	...
	τr::Float32=-1.f0 # rise timescale
	τd::Float32=-1.f0 # decay timescale
	g0::Float32= 0.f0 # g0 is peak conductance 
...
const MilesGabaDend = GABAergic(
 Receptor(E_rev = -75.,τr= 4.8, τd= 29., g0= 0.27),
 Receptor(E_rev = -90.,τr= 30, τd= 400., g0=0.006)
)

const MilesGabaSoma = GABAergic(
 Receptor(E_rev = -75.,τr= 0.3, τd= 15., g0= 0.38),
 Receptor()
)
...
const EyalGluDend_AMPA = Glutamatergic(
		 Receptor(E_rev=0.0, τr=0.26, τd=2.0,g0=2.),
		ReceptorVoltage()
)
